...
var SortingAnimation = function() {
    function shuffle(array, actions) {
        ...
        while (--i > 0) {
            ...
            array[i] = t;
            if (actions)
                actions.push({type: "shuffle", i: i, j: j});
        }
        return array;
    }
    ...
    var color = d3.scale.quantize().domain([height / 10, height]).range(["rgb(255,245,235)", "rgb(254,230,206)", "rgb(253,208,162)", "rgb(253,174,107)", "rgb(253,141,60)", "rgb(241,105,19)", "rgb(217,72,1)", "rgb(166,54,3)", "rgb(127,39,4)"]);
