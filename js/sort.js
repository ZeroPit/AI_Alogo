...
function initUserSort() {
    for (var key in UserSortDic) {
        new UserSorting(UserSortDic[key], key);
    }  
}
function addToUserSort(pSortAreaID, pSortID) {
    UserSortDic[pSortAreaID] = getSortClass(pSortID);
}
